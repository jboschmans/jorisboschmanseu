...
<head>
    ...
    <link href="{{ URL::asset('vendor/fortawesome/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                  ...
                  <a class="navbar-brand page-scroll" href="#page-top">Joris Boschmans</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Joris Boschmans</div>
                <div class="intro-heading">Developer</div>
                <a href="{{ URL::asset('documents/Joris_Boschmans_CV.pdf') }}" target="_blank" class="btn btn-xl">My resume</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Some of the things I like doing when I'm not developing</h3>
                </div>
            </div>
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('vendor/components/jquery/jquery.min.js') }}"></script>
